...
GROUPS = [
 ...
 ('News & Events', ['news'], [('News overview','news.html'),('Life at TVPlab','index.html#gallery-title'),('In the media',OLD+'in-the-media'),('Seminars',OLD+'technical-seminars')]),
