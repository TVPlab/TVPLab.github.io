...
## Adipocyte-inspired controls — 21 September 2026

All pages share `controls.css`: ivory lipid droplets, powder-blue cell membranes, espresso arrows and peripheral nuclei. Static inline SVG icons decorate links, People biography toggles, photo expansion, carousel controls and primary/profile buttons; lightbox icons use the same shapes. Language, menu and role filters share softened contours. The existing palette, page content and routes are preserved. SVGs are decorative and do not replace accessible button names. Hover movement is subtle and disabled under reduced-motion preferences; native details, links and no-JavaScript fallbacks remain functional.

Verification: all 18 pages fit 320 px; English and Chinese carousel/gallery controls passed at 1440, 768 and 390 px (bounds, keyboard navigation, modal close/focus restoration). People layout and filters passed six viewport/language combinations. Checked reduced motion, no-JavaScript biography expansion, mobile menu, original palette, and visually inspected link, filter, form, lightbox and carousel controls. The contact form remains an email-draft action; no email was sent.

Colour refinement: cell membranes now use soft peach (#EDC4A7), lipid droplets and selected-filter nuclei use cream yellow (#F7E4A7), following the owner’s request. The surrounding ivory, blue and espresso page palette remains unchanged.

## Dropdown navigation and international research — 21 September 2026

Restored grouped dropdowns across all seven existing primary navigation headings. Research separates scientific topics from the Nanjing, Valencia and collaborator destinations; the international column comes first on narrow screens. Media, seminars and MPhil/alumni links retain access to labelled original-site archives. Role links now activate the corresponding People filter, preserving Cherub first among PhD students and Ruoqi as a Research Associate.

The Research overview now includes selectable Cambridge/Nanjing/Valencia panels with genuine lab photographs and direct links. New bilingual Nanjing and Valencia pages present verified programme descriptions, institutional contacts and related groups. The collaborator directory includes all five institutions in the live original site, with type/research-area filters; the AstraZeneca misdirected link is corrected. See `NETWORK_SOURCES.md` for provenance and source limitations. Photos are locally hosted WebP files. Existing colours, TVP logo, hero and cell controls are preserved.

Verification: all 24 pages checked at 320 px with no document overflow, missing assets or page errors. Verified all internal links and anchors. English/Chinese interaction checks cover native dropdowns, mouse hover/click, keyboard navigation, outside dismissal, Escape closing one menu level at a time, laboratory tab switching, preservation of the selected laboratory across language changes, People role links and partner-filter counts. Without JavaScript, mobile dropdowns remain usable and all laboratory/partner content remains available. Desktop and mobile screenshots were inspected.

## News archive migration — 21 September 2026

Replaced the six placeholder news stories and the three homepage placeholders with sourced content. Imported all 45 original blog posts (2017–2026), original displayed dates and 64 local photo assets. Added eight verified public LinkedIn updates about collaboration, research and career development. News is bilingual, with search, year/topic filters, newest/oldest ordering, load-more, shareable story anchors, expandable content and original-source links. The dated CIPF career event includes an ICS calendar download. Homepage now displays the three newest verified updates. Updated News dropdown entries and the footer LinkedIn profile URL.

Content provenance, date rules, source limitations and maintenance are documented in NEWS_SOURCES.md. Static checks confirmed all 53 source IDs exactly once per language, date order, local assets, internal links and anchors; no placeholder story remains in served HTML.

Interaction checks passed for both languages: all seven topic counts, year+keyword search, empty results, reset, load-more, oldest-first ordering, deep-link expansion, preserved language anchors and no-JavaScript access to all 53 stories.
